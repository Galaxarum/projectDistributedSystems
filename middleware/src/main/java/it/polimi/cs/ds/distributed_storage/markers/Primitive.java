package it.polimi.cs.ds.distributed_storage.markers;

import it.polimi.cs.ds.distributed_storage.exceptions.BrokenProtocolException;

/**
 * Marker interface to mark classes encoding primitives (both at it.polimi.cs.ds.distributed_storage.middleware or application level)
 */
